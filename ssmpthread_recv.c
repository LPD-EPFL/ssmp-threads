...
inline 
void ssmpthread_recv_from(uint32_t from, volatile ssmp_msg_t *msg)
{
...
inline void 
ssmpthread_recv_color(ssmp_color_buf_t *cbuf, ssmp_msg_t *msg)
{
#if !defined(TILERA)
  uint32_t from;
...
inline void
ssmpthread_recv_color_start(ssmp_color_buf_t *cbuf, ssmp_msg_t *msg)
{
#if defined(NIAGARA)
  uint32_t num_ues = cbuf->num_ues;
...
#elif defined(OPTERON) | defined(local)
  volatile uint32_t** cbuf_state = cbuf->buf_state;
